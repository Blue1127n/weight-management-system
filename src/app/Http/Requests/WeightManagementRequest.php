...
class WeightManagementRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'current_weight' => 'required|numeric|between:0,999.9',
    ...
    public function messages()
    {
        return [
            ...
            'current_weight.between.numeric' => '4桁までの数字で入力してください',
            'current_weight.between.decimal' => '小数点は1桁以内で入力してください',
            'target_weight.required' => '目標の体重を入力してください',
            'target_weight.between.numeric' => '4桁までの数字で入力してください',
            'target_weight.between.decimal' => '小数点は1桁以内で入力してください',
            'date.required' => '日付を入力してください',
            'weight.required' => '体重を入力してください',
            'weight.numeric' => '数値で入力してください',
            'weight.between.numeric' => '4桁までの数字で入力してください',
            'weight.between.decimal' => '小数点は1桁で入力してください',
